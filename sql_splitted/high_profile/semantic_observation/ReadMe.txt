...
If you want to restore the dump, you have to execute the file semantic_observation_high_concurrency_DataStructure.sql first because it contains the structure like Tables.

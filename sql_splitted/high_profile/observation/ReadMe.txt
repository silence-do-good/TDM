...
If you want to restore the dump, you have to execute the file observation_high_concurrency_DataStructure.sql first because it contains the structure like Tables.
